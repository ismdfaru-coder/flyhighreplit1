...
import { z } from 'zod';
import { ClassicFlightSearchInput, ClassicFlightSearchOutput, ClassicFlightSearchInputSchema, ClassicFlightSearchOutputSchema, VisualFlightSearchInput, VisualFlightSearchInputSchema } from '@/types';
...
const classicFlightSearchFlow = ai.defineFlow(
  ...
  async ({ query }) => {
    ...
    if (!details) {
      throw new Error("Could not understand the flight details from your query. Please be more specific.");
    }
